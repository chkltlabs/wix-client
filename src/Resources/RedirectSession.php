...
class RedirectSession extends Domain
{
    protected string $segment = 'redirect-session';
    ...
    public function createRedirectSession(array $pathParams = [], array $params = []): object
    {
        return $this->executeOperation('post', 'v1/redirect-session', $pathParams, $params);
    }

    public function createRedirectSessionV1Session(array $pathParams = [], array $params = []): object
    {
        return $this->executeOperation('post', 'v1/session', $pathParams, $params);
    }

...
class V1 extends Domain
{
    ...
    {
        return $this->executeOperation('post', 'get-quota', $pathParams, $params);
    }

    public function listSuggestedKeywords(array $pathParams = [], array $params = []): object
    {
        return $this->executeOperation('post', 'list-suggested-keywords', $pathParams, $params);
    }
